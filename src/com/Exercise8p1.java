...
public class Exercise8p1 {
    ...
    public void execute() {
        ...
        System.out.print(getHigherVariable());
    ...
    private Integer getHigherVariable(){

        Integer highestValue = -10000;
        for(Map.Entry<String, Integer> variable: variables.entrySet()) {
            if (variable.getValue() > highestValue)
                highestValue = variable.getValue();
        }
