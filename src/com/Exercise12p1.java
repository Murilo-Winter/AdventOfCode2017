...
public class Exercise12p1 {
    ...
    ArrayList<Integer> visitedPrograms = new ArrayList<>();

    public void execute() {

        buildProgramsHash();

        calculateAccesses(0, programsHash.get(0));

        System.out.print(numberOfConnections);
    ...
    private void calculateAccesses(Integer program, List<Integer> connections) {
        ...
        for (Integer connection : connections) {
            if (!visitedPrograms.contains(connection))
                calculateAccesses(connection, programsHash.get(connection));
        }
    }
